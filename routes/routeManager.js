...
const { blockLocalhostMiddleware } = require("../middleware/blockLocalhost");
...
router.get("/domain-route-details", blockLocalhostMiddleware, domainRouteTrackingMiddleware, routeController.getDomainRouteDetails);
